...
bool SelectButtonLayer::init() {
	MenuItemSprite* startGameButtonItemSprite = MenuItemSprite::create(Sprite::createWithSpriteFrameName("selectStartButton.png"),
	...
	startGameButton->setPosition(Director::getInstance()->getWinSize().width/2, 150);

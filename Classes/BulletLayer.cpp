...
void BulletLayer::startShooting() {
	this->schedule(CC_SCHEDULE_SELECTOR(BulletLayer::addBullet), UserDefault::getInstance()->getFloatForKey("intervalOfAddBullet"));
}

void BulletLayer::stopShooting() {
	this->unschedule(CC_SCHEDULE_SELECTOR(BulletLayer::addBullet));
}
